...
```{r}
Aug24_CSS8_glm_day <- readRDS("../Analysis_2024/Aug24_CSS8_glm_day.rds") %>% mutate(CSS = 8) %>% mutate(Sel = gsub("C", "Cyclohex", Sel)) %>%
                                                                                mutate(Sel = gsub("E", "Ethanol", Sel)) %>%
                                                                                mutate(Sel = gsub("H", "H2O2", Sel)) %>% mutate(Selection = Sel)

Aug24_CSS1_glm_day <- readRDS("../Analysis_2024/Aug24_CSS1_glm_day.rds") %>% mutate(CSS = 1) %>% mutate(Sel = gsub("C", "Cyclohex", Sel)) %>%
                                                                                mutate(Sel = gsub("E", "Ethanol", Sel)) %>%
                                                                                mutate(Sel = gsub("H", "H2O2", Sel)) %>% mutate(Selection = Sel)
...
CuSO4_CSS8_glmer_1byRep <- readRDS("../Analysis_2024/CuSO4_CSS8_glmer_1byRepG.rds") %>% mutate(Selection = "Copper", CSS = 8)
CuSO4_CSS1_glmer_1byRep <- readRDS("../Analysis_2024/CuSO4_CSS1_glmer_1byRepG.rds") %>% mutate(Selection = "Copper", CSS = 1)
