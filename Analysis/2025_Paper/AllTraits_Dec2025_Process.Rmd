...
Just those that are cold shocked
...
################################################################################
HWMMFDMXY <- readRDS("HWMMFDMXY.mqc.rds") %>% mutate(Freeze = TRUE)
HWTCNDMXY <- readRDS("HWTCNDMXY.mqc.rds") %>% mutate(Freeze = TRUE)

H2LK2DMX2 %>% mutate(Freeze = FALSE) -> H22F

H2LKCDMX2 %>% filter(Bulk == "Freeze") %>% mutate(Freeze = TRUE) -> H2LFreeze

H2LKCDMX2 %>% filter(Bulk != "Freeze") %>% mutate(Freeze = FALSE) %>% rbind(H2LFreeze) %>%
  rbind(HWMMFDMXY, HWTCNDMXY) -> FreezeData

FreezeData %>% rbind(H22F) %>% pivot_wider(names_from = Allele, values_from = Reads) -> FridgeData

################################################################################


table(FridgeData$Bulk, FridgeData$Freeze, FridgeData$Parent)

FridgeData %>% filter(Bulk != "UNDETERMINED", Parent != "AIG") %>% 
  unnest(cols = c(Wine, Oak)) %>%
  mutate(logOdds = log(Wine/Oak)) -> FrLogOdds

################################################################################

table(FrLogOdds$Bulk, FrLogOdds$Freeze, FrLogOdds$Parent)

FrLogOdds %>% filter(Bulk %in% c("Dilute", "Freeze")) %>%
  filter(CHROM %in% c("I", "VIII") == FALSE) %>%
  ggplot(aes(x = POS, y = logOdds, color = Pool, shape = Freeze)) + geom_point(alpha = 0.3) +
  facet_grid(Parent~CHROM, scales = "free", space = "free") +
  theme(legend.position = "bottom")

# FrLogOdds %>% filter(Bulk %in% c("Dilute", "Freeze"), grepl(1, Parent)) %>%
#   filter(CHROM %in% c("I")) %>%
#   ggplot(aes(x = POS, y = logOdds, color = Pool, shape = Freeze)) + geom_point(alpha = 0.3) +
#   facet_grid(Parent~CHROM, scales = "free", space = "free")
# 
# FrLogOdds %>% filter(Bulk %in% c("Dilute", "Freeze"), grepl(8, Parent)) %>%
#   filter(CHROM %in% c("VIII")) %>%
#   ggplot(aes(x = POS, y = logOdds, color = Pool, shape = Freeze)) + geom_point(alpha = 0.3) +
#   facet_grid(Parent~CHROM, scales = "free", space = "free")

FreezeData %>% rbind(H22F)  %>% group_by(CHROM, Pool, Parent, Bulk, Allele, Dataset) %>%
  arrange(POS) %>%
  reframe(POS = POS, SmoothCount = frollapply(Reads, n = 200, FUN = cybr_weightedgauss, align = "center")) -> Fr_G200 #this takes forever

saveRDS(Fr_G200, file = "Fridge_Smoothed.rds")
  
################################################################################

Fr_G200 %>% filter(Bulk != "UNDETERMINED", Parent != "AIG") %>%
  mutate(Bulk = gsub("Freeze", "Dilute", Bulk)) %>%
  mutate(Bulk = gsub("Ethanol", "EtOH", Bulk)) %>%
  filter(CHROM != "M") -> Fr_200_filt


```


## Load in processed data for smoothing
...
HJ5HKDRX3b_rawdata_called_ex %>% mutate(Dataset = gsub(".fastq", "", Dataset)) %>% merge(MQC_Key) -> HJ5HKDRX3b #new
...
#table(HJ5HKDRX3b$Bulk, HJ5HKDRX3b$Parent, HJ5HKDRX3b$Rep) #Make sure only replicate B is used for zeocin
...
# rbind(HWTCNDMXY, HWMMFDMXY, H2LK2DMX2, H_HJ5HKDRX3b, H2LKCDMX2) %>% 
#   filter(Bulk %in% c("Dilute", "H2O2")) %>%
#   group_by(CHROM, POS, Allele, Pool, Parent, Bulk)  -> H2O2_Unsmoothed
# 
...
Paraquat_Unsmoothed %>% na.omit() -> Paraquat_Unsmoothed

rbind(H2LK2DMX2, Z_HJ5HKDRX3b, H2LKCDMX2) %>% filter(Bulk %in% c("Dilute", "Zeocin", "Zeo")) %>%
  group_by(CHROM, POS, Allele, Pool, Parent, Bulk) -> Zeocin_Unsmoothed
...
# Zeocin_rawdata_called_ex %>% ungroup() %>% select(Dataset) %>% distinct() %>% separate(Dataset, into = c("Pool")) %>% distinct() -> ZeoPools
# 
# H2O2_rawdata_called_ex %>% ungroup() %>% select(Dataset) %>% distinct() %>% separate(Dataset, into = c("Pool")) %>% distinct() -> HPools
```

Clear memory real quick
...
# Paraquat_Unsmoothed %>% distinct() -> Paraquat_Unsmoothed
...
# saveRDS(Cycloheximide_G200, file = "J25/Cycloheximide_G200_J25.rds")
# 
...
# saveRDS(Copper_G200, file = "J25/Copper_G200_J25.rds")
# 
...
# saveRDS(Fluconazole_G200, file = "J25/Fluconazole_G200_J25.rds")
# 
...
saveRDS(Ethanol_G200, file = "J25/Ethanol_G200_J25_xNAs.rds")

#Ethanol_G200 <- readRDS("J25/Ethanol_G200_J25.rds")
...
saveRDS(Paraquat_G200, file = "J25/Paraquat_G200_J25_xNAs.rds")

## REDOING - J25c indicates concatenated vcf, so called correctly
...
# Sanity Check Plots for log alleles

```{r}
Paraquat_G200 <- readRDS("J25/Paraquat_G200_J25.rds")

```

```{r, fig.width=10, fig.height=4, eval = FALSE}
Cycloheximide_G200 %>% ungroup() %>% filter(CHROM %in% c("I", "VIII", "M") == FALSE) %>% 
  pivot_wider(names_from = Allele, values_from = SmoothCount) %>% 
  unnest() %>%
  mutate(logOdds = log(Wine/Oak)) %>%
  ggplot(aes(x = POS, y = logOdds, color = Dataset, linetype = Parent)) + geom_line() +
...
H2O2_unsmoothed %>% ungroup() %>% 
  filter(CHROM %in% c("I", "VIII", "M") == FALSE, , Bulk == "H2O2", Parent == "Wine1", grepl(c("Ar", "Br"), Dataset)) %>% 
  ...
  #theme(legend.position = "none") +
  ggtitle("H2O2 Unsmoothed")


H2O2_unsmoothed %>% ungroup() %>% 
  filter(CHROM %in% c("I", "VIII", "M") == FALSE, Bulk == "H2O2", Parent == "Wine1") %>% 
  pivot_wider(names_from = Allele, values_from = Reads) %>% 
  unnest() %>%
  mutate(logOdds = log(Wine/Oak)) %>%
  ggplot(aes(x = POS, y = logOdds, color = Dataset, linetype = Parent)) + geom_line() +
...
Copper_G200 %>% ungroup() %>% filter(CHROM %in% c("I", "VIII", "M") == FALSE) %>% 
  pivot_wider(names_from = Allele, values_from = SmoothCount) %>% 
  unnest() %>%
  mutate(logOdds = log(Wine/Oak)) %>%
  ggplot(aes(x = POS, y = logOdds, color = Dataset, linetype = Parent)) + geom_line() +
...
Paraquat_G200 %>% ungroup() %>% filter(CHROM %in% c("I", "VIII", "M") == FALSE) %>% 
  pivot_wider(names_from = Allele, values_from = SmoothCount) %>% 
  unnest() %>%
  mutate(logOdds = log(Wine/Oak)) %>%
  ggplot(aes(x = POS, y = logOdds, color = Dataset, linetype = Parent)) + geom_line() +
  facet_grid(Bulk~CHROM, scales = "free", space = "free") +
  theme(legend.position = "none") +
  ggtitle("Paraquat_G200")

unique(Paraquat_G200$Pool)

Zeocin_G200 %>% ungroup() %>% filter(CHROM %in% c("I", "VIII", "M") == FALSE, Bulk == "Zeocin") %>% 
...
Ethanol_G200 %>% ungroup() %>% filter(CHROM %in% c("I", "VIII", "M") == FALSE) %>% 
    mutate(Bulk = gsub("EtOH", "Ethanol", Bulk)) %>%
  pivot_wider(names_from = Allele, values_from = SmoothCount) %>% 
  unnest() %>%
  mutate(logOdds = log(Wine/Oak)) %>%
  ...
  facet_grid(Bulk~CHROM, scales = "free", space = "free") +
  theme(legend.position = "none") +
  ggtitle("Ethanol_G200")

Fluconazole_G200 %>% ungroup() %>% filter(CHROM %in% c("I", "VIII", "M") == FALSE) %>% 
  pivot_wider(names_from = Allele, values_from = SmoothCount) %>% 
  unnest() %>%
  mutate(logOdds = log(Wine/Oak)) %>%
  ggplot(aes(x = POS, y = logOdds, color = Dataset, linetype = Parent)) + geom_line() +
...
#Save
saveRDS(Copper_CSS1_glm, file = "J25/Copper_CSS1_glm_J25.rds")
...
#Save
saveRDS(Copper_CSS8_glm, file = "J25/Copper_CSS8_glm_J25.rds")
```
...
#Save
saveRDS(Cyc_CSS1_glm, file = "J25/Cyc_CSS1_glm_J25.rds")
...
#Save
saveRDS(Cyc_CSS8_glm, file = "J25/Cyc_CSS8_glm_J25.rds")
```

### Hydrogen Peroxide 

```{r}
H2O2_G200 <- readRDS("J25/H2O2_G200d_J25c.rds")
...
#Save
saveRDS(H2O2_CSS1_glm, file = "J25/H2O2_CSS1_glm_J25_c.rds")
...
#Save
saveRDS(H2O2_CSS8_glm, file = "J25/H2O2_CSS8_glm_J25_c.rds")
...
#Save
saveRDS(Fluconazole_CSS1_glm, file = "J25/Fluconazole_CSS1_glm_J25.rds")
...
#Save
saveRDS(Fluconazole_CSS8_glm, file = "J25/Fluconazole_CSS8_glm_J25.rds")
...
#Save
saveRDS(Ethanol_CSS1_glm, file = "J25/Ethanol_CSS1_glm_J25.rds")
...
#Save
saveRDS(Ethanol_CSS8_glm, file = "J25/Ethanol_CSS8_glm_J25_H2LK2only.rds")
...
#Save
saveRDS(PQ_CSS1_glm, file = "J25/PQ_CSS1_glm_J25_xNAs.rds")
...
#Save
saveRDS(PQ_CSS8_glm, file = "J25/PQ_CSS8_glm_J25_xNAs.rds")
...
```{r}
Zeocin_G200 <- readRDS("J25/Zeocin_G200d_J25c.rds")
...
#Save
saveRDS(Zeocin_CSS1_glm, file = "J25/Zeocin_CSS1_glm_J25_c.rds")
...
#Save
saveRDS(Zeocin_CSS8_glm, file = "J25/Zeocin_CSS8_glm_J25_c.rds")
...
```{r}
Cycloheximide_G200<- readRDS("J25/Cycloheximide_G200_J25.rds")
H2O2_G200<- readRDS("J25/H2O2_G200d_J25c.rds")
Fluconazole_G200<- readRDS("J25/Fluconazole_G200_J25.rds")
Ethanol_G200<- readRDS("J25/Ethanol_G200_J25_xNAs.rds")
Copper_G200<- readRDS("J25/Copper_G200_J25.rds")
Paraquat_G200 <- readRDS("J25/Paraquat_G200_J25_xNAs.rds")
Zeocin_G200 <- readRDS("J25/Zeocin_G200_J25.rds")
```
...
saveRDS(Cyc_CSS8_q5, file = "J25/Cyc_CSS8_q5_J25.rds")
saveRDS(Cyc_CSS1_q5, file = "J25/Cyc_CSS1_q5_J25.rds")
...
saveRDS(Copper_CSS8_q5, file = "J25/Copper_CSS8_q5_J25.rds")
saveRDS(Copper_CSS1_q5, file = "J25/Copper_CSS1_q5_J25.rds")
...
saveRDS(H2O2_CSS8_q5, file = "J25/H2O2_CSS8_q5_J25.rds")
saveRDS(H2O2_CSS1_q5, file = "J25/H2O2_CSS1_q5_J25.rds")
...
saveRDS(Fluconazole_CSS8_q5, file = "J25/Fluconazole_CSS8_q5_J25.rds")
saveRDS(Fluconazole_CSS1_q5, file = "J25/Fluconazole_CSS1_q5_J25.rds")
...
# 
# saveRDS(Ethanol_CSS8_q5, file = "J25/Ethanol_CSS8_q5_J25.rds")
# saveRDS(Ethanol_CSS1_q5, file = "J25/Ethanol_CSS1_q5_J25.rds")
...
saveRDS(Zeocin_CSS8_q5, file = "J25/Zeocin_CSS8_q5_J25.rds")
saveRDS(Zeocin_CSS1_q5, file = "J25/Zeocin_CSS1_q5_J25.rds")
...
saveRDS(Paraquat_CSS8_q5, file = "J25/Paraquat_CSS8_q5_J25.rds")
saveRDS(Paraquat_CSS1_q5, file = "J25/Paraquat_CSS1_q5_J25.rds")
...
saveRDS(Cyc_CSS8_q5, file = "J25/Cyc_CSS8_q5_J25_s15.rds")
saveRDS(Cyc_CSS1_q5, file = "J25/Cyc_CSS1_q5_J25_s15.rds")
...
saveRDS(Copper_CSS8_q5, file = "J25/Copper_CSS8_q5_J25_s15.rds")
saveRDS(Copper_CSS1_q5, file = "J25/Copper_CSS1_q5_J25_s15.rds")
...
saveRDS(H2O2_CSS8_q5, file = "J25/H2O2_CSS8_q5_J25_s15.rds")
saveRDS(H2O2_CSS1_q5, file = "J25/H2O2_CSS1_q5_J25_s15.rds")
...
saveRDS(Fluconazole_CSS8_q5, file = "J25/Fluconazole_CSS8_q5_J25_s15.rds")
saveRDS(Fluconazole_CSS1_q5, file = "J25/Fluconazole_CSS1_q5_J25_s15.rds")
...
Ethanol_CSS1_perm %>% na.omit() %>% group_by(label) %>%
  summarize(quant = quantile(abs(zscore), 0.95)) -> Ethanol_CSS1_q5
# 
# saveRDS(Ethanol_CSS8_q5, file = "J25/Ethanol_CSS8_q5_J25_s15.rds")
# saveRDS(Ethanol_CSS1_q5, file = "J25/Ethanol_CSS1_q5_J25_s15.rds")
...
saveRDS(Zeocin_CSS8_q5, file = "J25/Zeocin_CSS8_q5_J25_s15.rds")
saveRDS(Zeocin_CSS1_q5, file = "J25/Zeocin_CSS1_q5_J25_s15.rds")
...
saveRDS(Paraquat_CSS8_q5, file = "J25/Paraquat_CSS8_q5_J25_s15.rds")
saveRDS(Paraquat_CSS1_q5, file = "J25/Paraquat_CSS1_q5_J25_s15.rds")
