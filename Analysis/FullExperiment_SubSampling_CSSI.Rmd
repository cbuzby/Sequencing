...
## Run 1/4 of the data and then use the half thresholds from permutations
...
CSSI_F_qsample_GLM %>% filter(CHROM != "I") %>% ggplot(aes(x = POS, y = Bulk_Zprime)) + 
