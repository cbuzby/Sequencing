...
DatasetKey <- data.frame(Dataset = c("OakI_CuSO4_C", "OakI_CuSO4_D", "WineI_CuSO4_C", "WineI_CuSO4_D"),
                         Parent = c("Oak", "Oak", "Wine", "Wine", "Wine"),
                         Bulk = c("Dilute", "CuSO4", "CuSO4", "Dilute"))
...
save(CSSI_CuSO4_concat, file = "CSSI_CuSO4_concat.Rdata")
...
## Actually permuting to calculate the FDR

See how often at every cutoff the Z-score is significant in the bulk permutations. This would be the total number of positives out of the entire thing because they'd be shuffled so there are no true positives. Rank the p-values of the shuffled Z-scores and then find the rank where 5% of them are true.
