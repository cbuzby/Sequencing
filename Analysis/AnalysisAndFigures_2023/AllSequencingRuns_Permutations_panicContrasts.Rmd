---
title: "GLM and Permutations for Contrasts -0.5, 0.5"
...
```{r}
HNGLVDRXY_allpQs <- readRDS("StandardGLM/Ec_HNGLVDRXY_allpQs.rds")
HTG3TDMXY_allpQs <- readRDS("StandardGLM/Ec_HTG3TDMXY_allpQs.rds")
HKTFTDRX2_allpQs <- readRDS("StandardGLM/Ec_HKTFTDRX2_allpQs.rds")
HVYTYDRX2_allpQs <- readRDS("StandardGLM/Ec_HVYTYDRX2_allpQs.rds")
HTG3TDMXY_allpQs_rep <- readRDS("StandardGLM/Ec_HTG3TDMXY_allpQs_rep.rds")

HVYTYDRX2_glm_Ec <- readRDS("HVYTYDRX2_glm_Ec.rds")
HNGLVDRXY_glm_Ec <- readRDS("HNGLVDRXY_glm_Ec.rds")
HKTFTDRX2_glm_Ec <- readRDS("HKTFTDRX2_glm_Ec.rds")
HTG3TDMXY_glm_Ec <- readRDS("HTG3TDMXY_glm_Ec.rds")
HTG3TDMXY_glm_Ec_rep <- readRDS("HTG3TDMXY_glm_Ec_rep.rds")
...
#   ggtitle("Effects, 0.5/-0.5, Interaction Peaks")
...
#   ggtitle("Z scores, 0.5/-0.5, Interaction Peaks")
# 
# CuSO4_contrastglm_cutoffs %>% filter(d == "Z", Factor != "cept") %>%
...
#   geom_hline(aes(yintercept = quant095, color = Factor)) +
#   geom_line() + facet_grid(Label ~ CHROM, space = "free", scales = "free") +
#   ggtitle("Z scores, 0.5/-0.5, Bulk Peaks")
# 
# CuSO4_contrastglm_cutoffs %>% filter(d == "Z", Factor != "cept") %>%
...
#   geom_hline(aes(yintercept = quant095, color = Factor)) +
#   geom_line() + facet_grid(Label ~ CHROM, space = "free", scales = "free") +
#   ggtitle("Z scores, 0.5/-0.5, Parent Peaks")
