...
#Using Gsub for this
gsub(FilteredData$Dataset, "HKTMWDRX2_n01_", "") #CHANGE THIS

FilteredData %>% mutate(DShort = gsub("HKTMWDRX2_n01_", "", Dataset),
...
tempFilteredData$Parent[grep("O", tempFilteredData$DS)] <- "OakI"
tempFilteredData$Parent[grep("W", tempFilteredData$DS)] <- "WineI"
...
saveRDS(object = cybr2Data, file = "Data/Zeocin_cybr2.rds")

cybr2Data <- readRDS("Data/Zeocin_cybr2.rds")
...
mydata %>% group_by(CHROM, POS) %>% 
  summarise(summary = glmfixed_rep(HOOa = Zeocin_Oak_A_Oak, 
                           HOWa = Zeocin_Oak_A_Wine, 
                           HWOa = Zeocin_Wine_A_Oak,
                           HWWa = Zeocin_Wine_A_Wine,
                           LOOa = Dilute_Oak_A_Oak,
                           LOWa = Dilute_Oak_A_Wine,
                           LWOa = Dilute_Wine_A_Oak, 
                           LWWa = Dilute_Wine_A_Wine,
                           
                           HOOb = Zeocin_Oak_B_Oak, 
                           HOWb = Zeocin_Oak_B_Wine, 
                           HWOb = Zeocin_Wine_B_Oak,
                           HWWb = Zeocin_Wine_B_Wine,
...
saveRDS(GLMdata, file = "Data/Zeocin_glm_c.rds")
