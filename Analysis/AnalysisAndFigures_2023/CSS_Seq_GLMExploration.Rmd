---
title: "CSS Sequence Analysis Template/ Mixed GLM Exploration"
date: "Jan, Aug 2023"
output:
  html_document:
    df_print: paged
...
GLM_PivotW_F7 <- readRDS("GLM_PivotW_F7.rds")
...
FlucGlmer %>% mutate(Param = Effect) %>% select(-Effect) %>% pivot_wider(names_from = Type, values_from = GLM) -> FlucGlmerPivot
