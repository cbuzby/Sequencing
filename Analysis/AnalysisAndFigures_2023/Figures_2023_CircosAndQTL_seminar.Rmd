...
cybrPurple(CuSO4_8_glm, peakslist = C_8_intpeaks, peakcolor = "#ED7B01")
cybrPurple(Fluc_8_glm, peakslist = F_8_intpeaks, peakcolor = "#ED7B01")

#GLMER PLOTS
cybrPurple(H2O2_8_glmer, peakslist = H8g_intpeaks, peakcolor = "#ED7B01")
cybrPurple(CuSO4_1_glmer, peakslist = C1g_intpeaks)
cybrPurple(H2O2_glmer, peakslist = H1g_intpeaks)
cybrPurple(Zeocin_8_glmer, peakslist = Z8g_intpeaks, peakcolor = "#ED7B01")
cybrPurple(Fluc_1_glmer, peakslist = F1g_intpeaks)

```

New Cutoffs, New GLMER plots
...
#NEW NEW CUTOFFS
cybrPurple(CuSO4_glm, peakslist = C_1_intpeaks_perm_b, cutoff = .38)
cybrPurple(CuSO4_8_glm, peakslist = C_8_intpeaks_perm_b, cutoff = .38, peakcolor = "#ED7B01")
cybrPurple(Fluc_glm, peakslist = F_1_intpeaks_perm_b, cutoff = .38)
cybrPurple(Zeocin_glm, peakslist = Z_1_intpeaks_perm_b, cutoff = 0.5)
cybrPurple(H2O2_8_glmer, peakcolor = "#ED7B01", cutoff = 2)
cybrPurple(Zeocin_8_glmer, peakcolor = "#ED7B01", cutoff = 2)
...
Fluc_glm %>% mutate(Sub = 1) %>% rbind(data.frame(Fluc_8_glm, Sub = 8), 
  ...
  geom_line(size = 1.2) + 
    ...
    ylab("") + xlab("")+ ggtitle("")+
  facet_grid(~CHROM, scales = "free", space = "free")  + 
  scale_color_manual(values = c("black",  "skyblue2", "gray")) + 
