...
pSNPs_all <- rbind(data.frame(pSNPs[,1:2], E = "A_REF"),
                   ...
                   data.frame(C8[,1:2], E = "C8"),
                   data.frame(C1B[,1:2], E = "C1"),
...
cybrPurple(CuSO4_8_glm, peakslist = c8p, cutoff = 0.4839316, peakcolor = "#ED7B01")
cybrPurple(Fluc_glm, peakslist = f1p, cutoff = 0.4260583)
cybrPurple(Zeocin_glm, peakslist = z1p, cutoff = 0.4024422)
cybrPurple(H2O2_8_glmer, peakslist = h8p, peakcolor = "#ED7B01", cutoff = 2.0160408)
cybrPurple(Zeocin_8_glmer, peakslist = z8p, peakcolor = "#ED7B01", cutoff = 2.0160408)
cybrPurple(Fluc_8_glm, peakslist = f8p, peakcolor = "#ED7B01", cutoff = 0.4839316)
