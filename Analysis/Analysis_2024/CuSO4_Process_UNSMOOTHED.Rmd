...
CuSO4_CSS8_glmer_unsm_PERM %>%
  ...
  reframe(POS = POS, SmoothCount = frollapply(abs(zscore), n = 200, FUN = cybr_weightedgauss, align = "center")) -> AllCuSO4_cybrG200_PERM

AllCuSO4_cybrG200_PERM %>% na.omit() %>% group_by(label, CSS) %>% summarize(q5 = quantile(abs(SmoothCount), 0.95)) -> q5_css_G200
