...
AIG_CU_cybrG50 %>% filter(label == "Bulk", CHROM == "VIII") %>% ggplot(aes(x = POS, y = (SmoothCount))) + geom_line(color = "skyblue2") +
  geom_line(data = Chr8Isolated, aes(x = POS, y = (zscore))) +
  geom_vline(xintercept = 212535) + ggtitle("CUP1 F2 and F12")

#FRE1
AllCu_plot %>% filter(label %in% c("Bulk"), CHROM == "XII") -> Chr12Isolated

AIG__CU_cybrG200 %>% filter(label == "Bulk", CHROM == "XII") %>% ggplot(aes(x = POS, y = (SmoothCount))) + geom_line(color = "skyblue2") +
  geom_line(data = Chr12Isolated, aes(x = POS, y = (zscore), linetype = CSS)) +
  geom_vline(xintercept = 568567) + ggtitle("FRE1 F2 and F12 G200")

AIG_CU_cybrG50 %>% filter(label == "Bulk", CHROM == "XII") %>% ggplot(aes(x = POS, y = (SmoothCount))) + geom_line(color = "skyblue2") +
  geom_line(data = Chr12Isolated, aes(x = POS, y = (zscore), linetype = CSS)) +
  geom_vline(xintercept = 568567) + ggtitle("FRE1 F2 and F12 G50")

#CHROM 7
AllCu_plot %>% filter(label %in% c("Bulk", "Interaction"), CHROM == "VII") -> Chr7Isolated

AIG__CU_cybrG200 %>% filter(label == "Bulk", CHROM == "XII") %>% ggplot(aes(x = POS, y = (SmoothCount))) + geom_line(color = "black") +
...
AIG_CU_cybrG50 %>% filter(label == "Bulk", CHROM == "XII") %>% ggplot(aes(x = POS, y = (SmoothCount))) + geom_line(color = "black") +
  geom_line(data = Chr7Isolated, aes(x = POS, y = (zscore), linetype = CSS, color = label)) +
