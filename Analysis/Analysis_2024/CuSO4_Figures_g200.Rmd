...
AllCuSO4_cybrG200 %>% merge(q5_css_G200) -> AllCu_plot
...
```{r}
AllCu_plot %>% pivot_wider(names_from = label, values_from = zscore) %>%
...
```{r}
AllCu_plot %>% pivot_wider(names_from = CSS, values_from = zscore) %>%
