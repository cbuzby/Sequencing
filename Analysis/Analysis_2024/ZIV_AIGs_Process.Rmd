...
saveRDS(Ziv_rawdata_called, file = "Ziv_rawdata_called.rds")
...
saveRDS(Ziv_rawdata_smoothed, file = "Ziv_rawdata_smoothed.rds")
...
saveRDS(CB_AIGs_called, file = "CB_AIGs_called.rds")
...
saveRDS(CB_AIGs_logOdds, file = "CB_AIGs_logOdds.rds")
```
