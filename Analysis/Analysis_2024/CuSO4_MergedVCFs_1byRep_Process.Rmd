...
cybr_weightedgauss <- function(myx){
  myy <- dnorm(1:length(myx), mean = length(myx)/2, sd = 100)
...
rawdata_called_ex <- readRDS("rawdata_called_ex_G200.rds")
...
saveRDS(rd_factor, "rd_factorG200.rds")
```
...
```{r}
rd_factor <- readRDS("rd_factorG200.rds")
