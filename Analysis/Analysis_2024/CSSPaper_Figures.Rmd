...
AllCuSO4_glmer_1byRep %>%
  ...
  geom_tile(data = AllBulkPeaks[AllBulkPeaks$CSS == "I",], aes(x = POS, y = -1, width = 1, height = 1), color = "red") +
  geom_tile(data = AllBulkPeaks[AllBulkPeaks$CSS == "VIII",], aes(x = POS, y = -2, width = 1, height = 1), color = "red") +
