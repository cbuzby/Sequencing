...
read.csv("C:/Users/Cassandra/Documents/R_FileTransfer/CuSO4_Phenotyping_2024.csv") %>% filter(Dilution == 1, Rep != "B_100") %>% 
  ...
  #ggplot(aes(x = factor(Dose), y = Survival_Percent, color = Strain)) + 
  geom_boxplot(size = 1, alpha = 0) + ggtitle("CuSO4 Survival by Strain") +
  ...
  scale_y_log10() +
  scale_color_manual(values = c("darkorange", "maroon4")) + xlab("mM CuSO4") + 
