...
Realistically we want to know what the standard deviation is like at each region though, and not with changes in actual score. So if we normalize everything to its mean, would that help?

Find the standard deviation of Z primes for replicates since that I can actually get my head around:
