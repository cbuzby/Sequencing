...
For a simple logistic regression, where there is only one factor and replicates, one could use a formula such as: 

$$log(Allele) \sim Effect + Replicate$$ 
...
Using absolute values and renaming effects
